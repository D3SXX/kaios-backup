...
def create_mms_element(doc, entry):
    ...
    mms.setAttribute('m_size', str(os.stat(os.curdir + "/MMS_images/" + entry["attachments"][0]["location"]).st_size))
    ...
    for i, attachment in enumerate(entry["attachments"]):
        ...
        part.setAttribute('data',  encode_image_to_base64(os.curdir + "/MMS_images/" + attachment["location"]))
